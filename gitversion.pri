# File from https://gist.github.com/grassator/11405930
...
GIT_VERSION_SHA = $$system($$BASE_GIT_COMMAND describe --always 2> $$NULL_DEVICE)

# Check if we only have hash without version number
!contains(GIT_VERSION,([0-9]+)[.]([0-9]+)) {
    # If there is nothing we simply use version defined manually
    isEmpty(GIT_VERSION_SHA) {
        GIT_VERSION = $$VERSION
        ...
        GIT_VERSION = $$VERSION-$$GIT_COMMIT_COUNT-g$$GIT_VERSION_SHA
    }
}
...
DEFINES += GIT_VERSION=\\\"$$GIT_VERSION_SHA\\\"
